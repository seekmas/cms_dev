...
if(!class_exists('XiAbstractViewBaseAdapt')) {
	if(interface_exists('JView')) {
		abstract class XiAbstractViewBaseAdapt extends JViewLegacy {}
	} else {
		class XiAbstractViewBaseAdapt extends JView {}
	}
}

abstract class XiAbstractView extends XiAbstractViewBaseAdapt
{
	
	protected $_model 			= null; // Will be set by controller
	public    $_component		= XI_COMPONENT_NAME;
	protected $_tpl 			= null;
	public 	  $options 			= array('domObject'=>'xiWindowBody','domProperty'=>'innerHTML');
	...
	public function get($tpl=null, $default = null)
	{
	...
	//XiTODO: Not compatible with JView::assgin() in develpoment mode
