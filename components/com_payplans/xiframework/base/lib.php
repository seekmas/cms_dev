...
//	}
	...
	{
		$modelForm = $this->_modelform;
		
		//unset _modelForm as it contains simple_xml_element object which can't be serialized	
		unset($this->_modelform);
		$clonedObj =  unserialize(serialize($this));
	...
	public function getModelform()
	{
		...
		// setup modelform
		$this->_modelform = XiFactory::getInstance($this->getName(), 'Modelform' , 'Payplans');
