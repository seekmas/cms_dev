...
*/	
	...
	protected function _renderCanvas()
	{
		ob_start();
		?>
			<div class="pp-dashboard-widget <?php echo $this->getOption('class_suffix','');?> <?php echo $this->getOption('style_class','');?>"
					id="<?php echo $this->_id ;?>" 
					style="width: <?php echo $this->getOption('width','100%');?>">
			<div class="well well-small clearfix"> 					
				<?php if($this->getOption('title','') != '') : ?>
					<h4 class="page-header small">
