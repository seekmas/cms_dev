...
//            var ajaxCall = { 'url': theurl, 'data': {}, 'iframe': iframe };
        ...
        var ajaxCall = {'url':theurl, 'data':options.data, 'iframe':options.iframe};
            ...
            xi.ui.dialog.create(ajaxCall, '', null,null);
    },
...
payplans.discount = {
        apply: function(orderId){
				...
				$("#app_discount_code_submit").button('loading');
...
/*--------------------------------------------------------------
  payplans.text
--------------------------------------------------------------*/
payplans.text = xi.cms.text;

//1.4 Backward compatibility
	//Joomla will not be defined for J1.5
	if(typeof(Joomla) === "undefined") {
	      var Joomla = {};
	}
Joomla.XiText = payplans.text;
...
payplans.wallet = {
        recharge: function(userId){
                ...
                $('#onproceed').attr('disabled','disabled');
            	url = "index.php?option=com_payplans&view=user&task=recharge&recharge_amount="+amount+"&user_id="+userId;
...
payplans.jQuery(document).ready(function(){
    ...
    $.timeago.settings.strings={
	     prefixAgo: null,
	     prefixFromNow: null,
	     suffixAgo: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_SUFFIX_AGO', 'ago'),
	     suffixFromNow: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_SUFFIX_FROM_NOW', 'from now'),
	     seconds: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_SECONDS', 'less than a minute'),
	     minute: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_MINUTE', 'about a minute'),
	     minutes: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_MINUTES', '%d minutes'),
	     hour: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_HOUR', 'about an hour'),
	     hours: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_HOURS', 'about %d hours'),
	     day: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_DAY', 'a day'),
	     days: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_DAYS', '%d days'),
	     month: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_MONTH', 'about a month'),
	     months: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_MONTHS', '%d months'),
	     year: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_YEAR', 'about a year'),
	     years: xi.cms.text._('COM_PAYPLANS_JS_TIMEAGO_YEARS', '%d years'),
	     numbers: [] 
    };
