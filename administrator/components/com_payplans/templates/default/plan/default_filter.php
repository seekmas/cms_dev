		...
		<div class=" span8 row-fluid">
			...
			<div class="span11">
				<div class="span3" style="min-width: 100px;">
					...
					<?php echo PayplansHtml::_('text.filter', 'title', 'plan', $filters, 'filter_payplans', $attr);?>
				</div>

				<div class="hidden-phone">&nbsp;</div>

				<div class="span3 hidden-phone pp-filter-gap-top" style="min-width: 100px;">
					<?php $attr = array('style' => 'class="pp-filter-width"')?>
					<?php echo PayplansHtml::_('boolean.filter', 'visible', 'plan', $filters, 'filter_payplans', $attr);?>
				</div>

				<div class="span3 hidden-phone pp-filter-gap-top" style="min-width: 100px;">
					<?php echo PayplansHtml::_('boolean.filter', 'published', 'plan', $filters, 'filter_payplans', $attr);?>
				</div>

				<div class="span3" style="min-width: 85px;">
