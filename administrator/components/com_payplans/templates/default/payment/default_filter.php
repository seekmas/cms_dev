...
<div class="pp-filter-warp clearfix">
	<div class="pp-filters pp-grid_12 cleafix pp-alpha pp-omega">
		...
		<div class="pp-filter">
			<div class="pp-label" style="border:0px;">&nbsp;</div>
			<div class="pp-input">
				<?php echo PayplansHtml::_('apps.filter', 'app_id', 'payment', $filters, 'payment');?>
			</div>
		</div>	
		
		<div class="pp-filter">	
			<div class="pp-label">
				<?php echo XiText::_('COM_PAYPLANS_PAYMENT_GRID_CREATED_DATE');?>
			</div>
			<div class="pp-input">
				<?php echo PayplansHtml::_('range.filter', 'created_date', 'payment', $filters, 'date');?>
			</div>
		</div>
		
		<div class="pp-filter">	
			<div class="pp-label">
				<?php echo XiText::_('COM_PAYPLANS_PAYMENT_GRID_MODIFIED_DATE');?> 
			</div>
			<div class="pp-input">
				<?php echo PayplansHtml::_('range.filter', 'modified_date', 'payment', $filters, 'date');?>
			</div>
		</div>
	</div>	
</div>
